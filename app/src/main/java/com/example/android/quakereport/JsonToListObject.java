...
public class JsonToListObject {
    ...
    private static String s = "\n" +
            ...
            "        \"types\": \",cap,dyfi,finite-fault,general-text,geoserve,impact-link,impact-text,losspager,moment-tensor,nearby-cities,origin,phase-data,shakemap,tectonic-summary,trump-origin,\",\n" +
            "        \"nst\": null,\n" +
            "        \"dmin\": 0.72,\n" +
            "        \"rms\": 2.11,\n" +
            "        \"gap\": 19,\n" +
    ...
    public List<Earthquake> getList () {
        ...
        try {
            ...
            JSONArray myJsonArray = myJsonObject.getJSONArray("features");

            for (int i = 0; i < myJsonArray.length() ; i++){

                Earthquake e = new Earthquake();

                JSONObject myJsonObject2 = (JSONObject) myJsonArray.get(i);
                e.setmMagnitude(myJsonObject2.getJSONObject("properties").getDouble("mag"));

                String place = myJsonObject2.getJSONObject("properties").getString("place");
